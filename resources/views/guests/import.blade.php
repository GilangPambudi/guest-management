<form action="{{ url('/guests/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_guests.xlsx') }}" class="btn btn-info btn-sm" download><i
