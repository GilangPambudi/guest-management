            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $guest->guest_address }}" type="text" name="guest_address" id="guest_address" class="form-control" required>
                        <small id="error-guest_address" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Guest QR Code</label>
                        <input value="{{ $guest->guest_qr_code }}" type="text" name="guest_qr_code" id="guest_qr_code" class="form-control" required>
                        <small id="error-guest_qr_code" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Guest Attendance Status</label>
                    ...
                    <div class="form-group">
                        <label>Guest Invitation Status</label>
