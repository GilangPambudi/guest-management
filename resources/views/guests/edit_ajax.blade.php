...
@else
    <form action="{{ url('/invitation/' . $guest->invitation_id . '/guests/' . $guest->guest_id . '/update_ajax') }}" method="POST" id="form-edit-guest">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ $guest->guest_name }}" type="text" name="guest_name" id="guest_name" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ $guest->guest_category }}" type="text" name="guest_category" id="guest_category" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ $guest->guest_contact }}" type="text" name="guest_contact" id="guest_contact" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="guest_attendance_status" id="guest_attendance_status" class="form-control" required>
                                <option value="-" {{ $guest->guest_attendance_status == '-' ? 'selected' : '' }}>Not Set</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="guest_invitation_status" id="guest_invitation_status" class="form-control" required>
                                <option value="-" {{ $guest->guest_invitation_status == '-' ? 'selected' : '' }}>Not Set</option>
                                <option value="Sent" {{ $guest->guest_invitation_status == 'Sent' ? 'selected' : '' }}>Sent</option>
                                <option value="Pending" {{ $guest->guest_invitation_status == 'Pending' ? 'selected' : '' }}>Pending</option>
                            </select>
    ...
    $(document).ready(function() {
        ...
        $("#form-edit-guest").validate({
            ...
            submitHandler: function(form, event) {
                ...
                $('#btn-update').prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Updating...');
                
                // Show loading
                Swal.fire({
                    title: 'Processing...',
                    text: 'Updating guest data. Please wait...',
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.close();
                        $('#btn-update').prop('disabled', false).html('<i class="fas fa-save"></i> Update');
                    ...
                    error: function(xhr, status, error) {
                        ...
                        var errorMessage = 'Failed to update guest data.';
